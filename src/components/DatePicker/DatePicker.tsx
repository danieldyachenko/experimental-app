...
import { DatePickerInput, DatePickerRoot, DropdownPanel, PaginationBtn, Top, CurrentDateTitle, WeeksContainer, WeekText, DaysContainer, Day } from './styled'
...
export default function DatePicker() {
    ...
    return (
        <DatePickerRoot>
            <DatePickerInput onClick={openDropdownPanel} value={inputValue} readOnly />
            {open &&
                <DropdownPanel isAnimated={isAnimated} ref={datePickerElement} onAnimationEnd={onAnimationEnd}>
                    ...
                    <DaysContainer>
                        {days.map(day => (
                            <Day key={day} onClick={() => onDayClick(day)}>
                                <div>{day}</div>
                            </Day>
                        ))}
                    </DaysContainer>
